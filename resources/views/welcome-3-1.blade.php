...
<form method="POST" action="{{ route('download.video') }}">
    ...
    <div>
        ...
        <input type="number" name="start_minute" id="start_minute" min="0" required />
        <label for="start_second">Seconde de début :</label>
        <input type="number" name="start_second" id="start_second" min="0" max="59" required />
    </div>

    <div>
        <label for="end_minute">Minute de fin :</label>
        <input type="number" name="end_minute" id="end_minute" min="0" required />
        <label for="end_second">Seconde de fin :</label>
        <input type="number" name="end_second" id="end_second" min="0" max="59" required />
    </div>
